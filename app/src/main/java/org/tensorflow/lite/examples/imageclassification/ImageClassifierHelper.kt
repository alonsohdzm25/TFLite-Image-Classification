...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        val modelName =
            when (currentModel) {
                ...
                MY_CUSTOM_QUANT_MODEL -> "model_quant.tflite"
    ...
    companion object {
        ...
        const val MY_CUSTOM_QUANT_MODEL = 1
        const val MODEL_MOBILENETV1 = 2
        const val MODEL_EFFICIENTNETV0 = 3
        const val MODEL_EFFICIENTNETV1 = 4
        const val MODEL_EFFICIENTNETV2 = 5
